...
void man(char * name)
{
    ...
    {
        printf("Discription : Used to write in regular file \n");
        printf("Usage : write File_name\n After that enter data that you want to write\n");
    }
    ...
    {
        printf("Discription : used to remove tha data from file ");
    ...
    {
        printf("Discription : used to closed opened file\n");
    ...
    {
        printf("Discription : used to delete file\n");
...
void DisplayHelp()
{
    ...
    printf("write  :to write the content into the file\n");
...
void CreateDILB()
{
    ...
    printf("DILB successfully create\n");
}
...
//              Demo.txt      3(read+write)
int CreateFile(char *name ,int permission)   // char name[] or char *name
{
    int i = 3;               // ufdtarr chy pahile(0,1,2 --index) 3 reserve hote mhanun
    PINODE temp = head;
...
void ls_file()
{
    ...
    while(temp!=NULL)                     
    {
        if(temp->FileType!=0)           // maxinode - free inode = used inode
        {
...
int fstat_file(int fd)
{
    ...
    if(temp->permission == 1)
            ...
            printf("File permisssion :Write Only\n");
...
int main()
{
    ...
    while(1)
    {
        ...
        else if(count == 3) 
        {
            ...
            {   
                // create Demo.txt 3        -- terminal command
